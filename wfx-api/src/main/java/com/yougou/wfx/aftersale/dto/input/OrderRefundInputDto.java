 ...
 */
public class OrderRefundInputDto extends PageModel<OrderRefundInputDto> {
	...
	public Boolean getIsAdminOperate() {
		return isAdminOperate;
	}

	public void setIsAdminOperate(Boolean isAdminOperate) {
