...
/**
 * SupplierAddressPageInputDto
 * @author wfx
 * @Date 创建时间：2016-04-26 09:34:43
 */
public class SupplierAddressPageInputDto extends InputDto{
	...
	public SupplierAddressPageInputDto(){
	}
	...
	public void setOutsideNo(Integer value) {
		value = value == null ? 0 : value;
		this.outsideNo = value;
	}
	
	public Integer getOutsideNo() {
		return this.outsideNo == null ? 0 : this.outsideNo;
	}
