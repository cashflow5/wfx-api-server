 ...
 */
public class OrderApplyOutputDto extends OutputDto {
	 ...
	 * 物流信息
	 */
	private List<OrderConsignOutputDto>  orderConsign;
	/**
	 * 备注信息
	 */
	private List<OrderRemarkOutputDto>  orderRemark;


	public List<OrderRemarkOutputDto> getOrderRemark() {
		return orderRemark;
	}

	public void setOrderRemark(List<OrderRemarkOutputDto> orderRemark) {
	...
	public List<OrderConsignOutputDto> getOrderConsign() {
		return orderConsign;
	}

	public void setOrderConsign(List<OrderConsignOutputDto> orderConsign) {
