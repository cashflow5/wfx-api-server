...
/**
 * CommodityCatb2cInputDto
 * 
 * @author wzf
 * @Date 创建时间：2016-03-24 16:06:23
 */
public class CommodityCatb2cInputDto extends PageModel<CommodityCatb2cInputDto> {
	...
	public CommodityCatb2cInputDto() {
	}

	public CommodityCatb2cInputDto(String id) {
		this.id = id;
	}
