...
/**
 * CommodityStyleInputDto
 * @author zhang.wj
 * @Date 创建时间：2016-03-24 16:58:55
 */
public class CommodityStyleInputDto extends PageModel<CommodityStyleInputDto> {
	...
	public CommodityStyleInputDto(){
	}

	public CommodityStyleInputDto(String id){
		this.id = id;
	}
