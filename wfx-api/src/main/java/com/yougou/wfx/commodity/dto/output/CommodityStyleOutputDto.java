...
/**
 * CommodityStyleOutputDto
 * @author zhang.wj
 * @Date 创建时间：2016-03-24 16:58:55
 */
public class CommodityStyleOutputDto extends OutputDto {
	 ...
	 * 图片list
	 */
	private List<CommodityPicsOutputDto> picsDto;
	/**
	 * 货品信息
	 */
	private List<CommodityProductOutputDto>  productDto;
	...
	public void setBaseCatId(String baseCatId) {
	 ...
	 * 代理商品上下架状态 1上架，2下架
	 */
	private int  sellerCommodityStatus;
	/**
	 * 代理商品Id
	 */
	...
	public void setSellerFlag(String sellerFlag) {
   	...
   	public int getSellerCommodityStatus() {
		return sellerCommodityStatus;
	}

	public void setSellerCommodityStatus(int sellerCommodityStatus) {
		this.sellerCommodityStatus = sellerCommodityStatus;
	}
	...
	public void setSellerCommodityId(String sellerCommodityId) {
	...
	public List<CommodityProductOutputDto> getProductDto() {
		return productDto;
	}

	public void setProductDto(List<CommodityProductOutputDto> productDto) {
		this.productDto = productDto;
	}

	public List<CommodityPicsOutputDto> getPicsDto() {
		return picsDto;
	}

	public void setPicsDto(List<CommodityPicsOutputDto> picsDto) {
		this.picsDto = picsDto;
	}
	...
	public CommodityStyleOutputDto(){
	}
