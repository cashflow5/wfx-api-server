...
/**
 * CommissionDetailInputDto
 * @author langqiwei
 * @Date 创建时间：2016-03-29 10:46:58
 */
public class CommissionDetailInputDto extends PageModel<CommissionDetailInputDto> {
	...
	/**
	 * 店铺名称:tbl_wfx_shop.name
	 */
	private String wfxShopName;
	/**
	 * 分销商账号:tbl_wfx_member_account.login_name
	 */
     ...
     * 微分销主订单号
     */
    private String wfx_order_no;
    
    public String getWfx_order_no() {
        return wfx_order_no;
    }

    public void setWfx_order_no(String wfx_order_no) {
        this.wfx_order_no = wfx_order_no;
    }
    ...
    public CommissionDetailInputDto(){
	}
	...
	public void setDeductRatio(Integer value) {
		value = value == null ? 0 : value;
