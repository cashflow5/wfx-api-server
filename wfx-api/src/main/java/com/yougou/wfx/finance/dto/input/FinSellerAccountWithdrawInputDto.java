...
/**
 * FinSellerAccountWithdrawInputDto
 * @author wfx
 * @Date 创建时间：2016-03-31 10:10:25
 */
public class FinSellerAccountWithdrawInputDto extends InputDto{
	...
	/**
	 * 单据状态. 1,待审核;2,已审核,3,已体现,4,审核不通过
	 */
	...
	public FinSellerAccountWithdrawInputDto(){
	}
