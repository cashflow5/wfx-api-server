...
/**
 * DiscoverCarouselFigureEntity
 * @author wang.zf
 * @Date 创建时间：2016-06-02 10:14:16
 */
public class DiscoverCarouselFigureEntity implements java.io.Serializable{
	 ...
	 * 文章
	 */
	private DiscoverArticleEntity discoverArticle = new DiscoverArticleEntity();
//columns END

	public DiscoverCarouselFigureEntity(){
	}
	...
	public DiscoverArticleEntity getDiscoverArticle() {
		return discoverArticle;
	}

	public void setDiscoverArticle(DiscoverArticleEntity discoverArticle) {
