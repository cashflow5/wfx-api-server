...
/**
 * CommissionPercentEntity
 * @author langqiwei
 * @Date 创建时间：2016-03-25 11:09:26
 */
public class CommissionPercentEntity implements java.io.Serializable{
...
//columns START
    ...
    public String getBaseCatLevel() {
        return baseCatLevel;
    }

    public void setBaseCatLevel(String baseCatLevel) {
        this.baseCatLevel = baseCatLevel;
    }

    public CommissionPercentEntity(){
	}
